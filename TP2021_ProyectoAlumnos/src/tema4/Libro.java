...
public class Libro {
   ...
   private double precio; 
    ...
    int unAñoEdicion,  String nombre,String biografia, String unISBN, double unPrecio){
         titulo = unTitulo;
         editorial = unaEditorial; 
         añoEdicion= unAñoEdicion;
         primerAutor.setNombre(nombre);
         primerAutor.setBiografia(biografia);
         ISBN =  unISBN;
         precio = unPrecio;
    }
    
    public Libro(  String unTitulo,  String unaEditorial, String nombre,String biografia, String unISBN){
         titulo = unTitulo;
         editorial = unaEditorial; 
         añoEdicion= 2015;
         primerAutor.setNombre(nombre);
